...
buttonContainer.innerHTML = `
      <button class="medium_text download py-1 px-2 m-2 bg-success text-light w-100">Download</button>
      <button class="medium_text reset py-1 px-2 m-2 border none bg-danger text-light w-100">Reset</button>
      <button class="medium_text restart py-1 px-2 m-2 border none bg-warning w-100">Restart</button>
`;
...
async function handleUploadedFiles(uploadedFile) {
  ...
  loadingElement.innerHTML = `<p class="text-center" style="align-self: center">Loading Image...</p>`;
