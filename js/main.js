...
documentationDiv.innerHTML = `
    ...
    <p class="mb-0 hide_documentation_btn text-danger bg-white p-2 small_text">CLOSE</p>
      ...
      <p class="gradient_text mb-0 text-danger" style="padding: 0 0 0 2rem"><b>Developer's Note: </b></p>
      <p style="padding: 0 0 0 2rem">Implementation of client-side video conversion is not feasible due to the complexity and resource-intensive nature of video transcoding. Most modern video formats involve encoding, decoding, and compression techniques that require significant computational power and are typically done on server-side platforms.
      <br><br>
