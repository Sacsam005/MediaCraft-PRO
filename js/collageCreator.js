...
// drag and drop OR upload files input div
...
const imageGridSection = document.querySelector(".image_grid_section");
...
downloadCollageBtn.setAttribute(
  "class",
  "py-1 px-2 mt-2 bg-success text-light medium_text download"
);
...
uploadFilesContainer.innerHTML = `
        ...
        <label
          for="fileInput"
          class="px-3 py-2 border border-1"
